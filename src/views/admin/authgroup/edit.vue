    ...
    <div>
        <div class="x-breadcrumbs">
            <mu-breadcrumbs>
                ...
                <mu-breadcrumbs-item :disabled="true">编辑角色</mu-breadcrumbs-item>
            </mu-breadcrumbs>
        </div>
...
export default {
    ...
    methods: {
        ...
        add_ajax: function() {
            ...
            this.$refs.form.validate().then((result) => {
                if( result ){
                    ...
                    _this.xzyn.ajax('/admin/authgroup/edit','post',_this.add_data,{},function(data,res){
                        _this.xzyn.go();
                    })
                }
            });
        ...
        ajax_data: function(){
            var _this = this;
            _this.xzyn.ajax('/admin/authgroup/edit','get',{id: _this.$route.query.id},{},function(data,res){
                _this.rules_list = data.rules_data;
                _this.add_data = data.data;
                _this.rules_id_arr = data.data.rules;
            },false)
        }
