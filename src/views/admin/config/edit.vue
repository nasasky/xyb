    ...
    <div>
        <div class="x-breadcrumbs">
            <mu-breadcrumbs>
                ...
                <mu-breadcrumbs-item :disabled="true">编辑配置字段</mu-breadcrumbs-item>
            </mu-breadcrumbs>
        </div>
...
export default {
    ...
    methods: {
            ...
            this.$refs.form.validate().then((result) => {
                if( result ){
                    if( _this.add_data.texttype == 'select' && !_this.add_data.textvalue ){
                        ...
                        _this.xzyn.ajax('/admin/config/edit','post',_this.add_data,{},function(data,res){
                            _this.xzyn.go();
                        })
                    }
                }
        ...
        ajax_data: function(){
            var _this = this;
            _this.xzyn.ajax('/admin/config/edit','get',{id: _this.$route.query.id},{},function(data,res){
                console.log(data)
                _this.add_data = data.configData;
