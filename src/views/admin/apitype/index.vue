    ...
    <div>
        <div class="x-breadcrumbs">
            <mu-breadcrumbs>
                ...
                <mu-breadcrumbs-item :disabled="true">API分类列表</mu-breadcrumbs-item>
            </mu-breadcrumbs>
            <mu-button class="x-dwa-rt x-mt-10 x-mr-10" color="primary" small @click="xzyn.go('/admin/apitype/create')">新增</mu-button>
        </div>
        ...
        <mu-popover cover :open.sync="open" :trigger="trigger" class="x-p-15 x-yy-0" style="background: rgba(0,0,0,0);">
            <mu-button fab color="primary" class="x-mr-5" small @click="xzyn.go('/admin/apitype/edit?id='+this_data.id)">
...
export default {
    ...
    data() {
        ...
        return {
            ...
            columns: [
                ...
                { title: '分类名称', name: 'name', align: 'center'},
    ...
    methods: {
        ...
        ajax_data: function(){
            ...
            _this.xzyn.ajax('/admin/apitype/index','get',add_data,{},function(data,res){
        ...
        del_ajax: function(){
            ...
            this.$confirm('你确定要删除吗？', '提示').then((res)=>{
                if( res.result ){
                    this.xzyn.ajax('/admin/apitype/delete','post',{id:this.this_data.id},{},function(data,res){
                        var new_data = [];
