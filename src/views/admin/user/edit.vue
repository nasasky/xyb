    ...
    <div>
        <div class="x-breadcrumbs">
            <mu-breadcrumbs>
                ...
                <mu-breadcrumbs-item :disabled="true">编辑用户</mu-breadcrumbs-item>
            </mu-breadcrumbs>
        </div>
    ...
    methods: {
        ...
        add_ajax: function() {
            ...
            this.$refs.form.validate().then((result) => {
                if( result ){
                    _this.xzyn.ajax('/admin/user/edit','post',_this.add_data,{},function(data,res){
                        _this.xzyn.go();
                    })
                }
            });
        ...
        ajax_data: function(){
            var _this = this;
            _this.xzyn.ajax('/admin/user/edit','get',{id: _this.$route.query.id},{},function(data,res){
                _this.add_data = data;
            },false)
        },
        // 选择生日触发
