...
export default {
    ...
    methods: {
        ...
        add_ajax: function() {
            ...
            this.$refs.form.validate().then((result) => {
                if( result ){
                    ...
                    _this.xzyn.ajax('/admin/authrulem/edit','post',_this.add_data,{},function(data,res){
                        _this.xzyn.go();
                    })
                }
            });
        ...
        ajax_data: function(){
            var _this = this;
            _this.xzyn.ajax('/admin/authrulem/edit','get',{id: _this.$route.query.id},{},function(data,res){
