    ...
    <div>
        <div class="x-breadcrumbs">
            <mu-breadcrumbs>
                ...
                <mu-breadcrumbs-item :disabled="false" to="/admin/authrulem/index">会员权限列表</mu-breadcrumbs-item>
                <mu-breadcrumbs-item :disabled="true">新增权限地址</mu-breadcrumbs-item>
            </mu-breadcrumbs>
        </div>
...
export default {
    ...
    methods: {
        ...
        add_ajax: function() {
            ...
            this.$refs.form.validate().then((result) => {
                if( result ){
                    ...
                    _this.xzyn.ajax('/admin/authrulem/create','post',_this.add_data,{},function(data,res){
                        _this.xzyn.go();
                    })
                }
            });
        ...
        ajax_data: function(){
            var _this = this;
            _this.xzyn.ajax('/admin/authrulem/create','get',{},{},function(data,res){
