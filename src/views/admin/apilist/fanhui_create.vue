    ...
    <div>
        <div class="x-breadcrumbs">
            <mu-breadcrumbs>
                ...
                <mu-breadcrumbs-item :disabled="false" :to="url_list_btn">返回字段列表</mu-breadcrumbs-item>
...
export default {
    ...
    computed: {
        ...
        url_list_btn: function(){
            return '/admin/apilist/fanhui_index?type='+this.$route.query.type+'&hash='+this.$route.query.hash;
        }
    },
    //监控data中的数据变化
    watch: {
